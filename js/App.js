...
export default function App() {
    ...
    return (stdout.rows >= 15 ? React.createElement(Box, { flexDirection: "column", height: 15, borderStyle: 'classic' }, navi.configOpen ?
        React.createElement(Text, null) :
        navi.editMacro !== undefined ?
            React.createElement(EditMacro, { config: config, macros: [macros, macroDispatch], navi: [navi, naviDispatch] }) :
            React.createElement(Macros, { config: config, macros: macros, navi: [navi, naviDispatch] })) : React.createElement(Text, null, "Expand Terminal to 15 rows ~please~"));
}
